...
export default class HelpCommand implements CliCommandInterface {
  ...
  //TODO: npm run ts ./src/main.cli.ts -- --import ./mocks/mock-data.tsv admin test localhost six-cities secret
  //TODO: npm run ts ./src/main.cli.ts -- --generate 50 ./mocks/test-data.tsv http://localhost:3123/api изменить описание импорта
